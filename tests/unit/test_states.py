...
try:
    ...
    def init_game(use_black_screen=True, tutorial_mode=False):
        ...
        try:
            ...
            # Log configuration
            game_logger.info(
                f"Test configuration: simplified={use_black_screen}, tutorial_mode={tutorial_mode}",
                "test_states",
            )
            ...
            game_logger.error(
                f"Error initializing game: {e}", "test_states", exc_info=True
            )
            raise
    ...
    def print_keyboard_commands():
        ...
        print("\nTUTORIAL COMPLETION:")
        print(
            "Press SPACE repeatedly to simulate 5 deliveries or earn $50 to complete the tutorial."
        )
        print("------------------\n")
    ...
    if __name__ == "__main__":
        ...
        print("\nInitializing game...")
        game = init_game(
            use_black_screen=USE_BLACK_SCREEN, tutorial_mode=RESET_TUTORIAL
        )
