...
def check_database():
    ...
    try:
        ...
        try:
            from src.persistence.db_init import DB_PATH, initialize_database, check_database_integrity
            from src.debug.logger import game_logger
            print(f"Successfully imported database modules")
        ...
        try:
            ...
            if integrity_result:
                ...
                print(f"✗ Database integrity check failed. Missing tables: {missing_tables}")
                ...
                if integrity_result:
                    ...
                    print(f"✗ Database still has issues. Missing tables: {missing_tables}")
        except Exception as e:
