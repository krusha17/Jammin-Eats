...
class TestInputValidator:
    ...
    def test_name_sanitization(self):
        ...
        assert validator.sanitize_player_name("Player;DROP TABLE scores;") == "PlayerDROP TABLE scores"
        
        # Test name length limits
        assert validator.sanitize_player_name("") is None, "Empty name should be rejected"
        long_name = "A" * 30
