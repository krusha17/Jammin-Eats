...
class TestEconomyManager:
    ...
    def test_delivery_rewards(self):
        ...
        assert economy.money == initial_money + reward, "Money should increase by reward amount"
    ...
    def test_difficulty_scaling(self):
        ...
        assert medium_reward > easy_reward, "Higher difficulty should give better rewards"
        assert hard_reward > medium_reward, "Higher difficulty should give better rewards"
    ...
    def test_combo_decay(self):
        ...
        assert economy.combo_multiplier < initial_multiplier, "Combo should decay over time"
