...
def test_space_increments_money(mock_game, test_id):
    ...
    assert mock_game.successful_deliveries == 1, "SPACE key should increment deliveries by 1"
...
def test_enter_persists_completion(monkeypatch, mock_game, test_id):
    ...
    monkeypatch.setattr("src.states.tutorial_complete_state.mark_tutorial_complete", 
    ...
    assert mock_game.tutorial_completed is True, "Game's tutorial_completed flag should be set"
