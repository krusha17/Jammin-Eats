...
def test_tutorial_completion():
    ...
    class SimpleTutorialTest:
        ...
        def check_completion(self):
            ...
            if self.money >= self.target_money or self.successful_deliveries >= self.target_deliveries:
        ...
        def draw(self, screen):
            ...
            deliveries_text = self.font.render(f"Deliveries: {self.successful_deliveries}", True, (255, 255, 255))
            
            # Draw goals
            money_goal = self.font.render(f"Goal: ${self.target_money}", True, (200, 200, 200))
            deliveries_goal = self.font.render(f"Goal: {self.target_deliveries} deliveries", True, (200, 200, 200))
            ...
            status_text = self.font.render(f"Tutorial Status: {status}", True, status_color)
            
            # Draw instructions
            instr1 = self.font.render("Press M: Add $10", True, (200, 200, 200))
            instr2 = self.font.render("Press D: Add 1 Delivery", True, (200, 200, 200))
            instr3 = self.font.render("Press SPACE: Mark Complete in DB", True, (200, 200, 200))
