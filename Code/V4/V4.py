...
try:
    background = pygame.image.load('assets/backgrounds/level1.png').convert()
...
class Player(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        try:
            self.image_up = pygame.image.load('assets/characters/kai_up.png').convert_alpha()
        except pygame.error as e:
        ...
        try:
            self.image_down = pygame.image.load('assets/characters/kai_down.png').convert_alpha()
        except pygame.error as e:
        ...
        try:
            self.image_left = pygame.image.load('assets/characters/kai_left.png').convert_alpha()
        except pygame.error as e:
        ...
        try:
            self.image_right = pygame.image.load('assets/characters/kai_right.png').convert_alpha()
        except pygame.error as e:
