    ...
    try:
        ...
        if os.path.exists(DB_PATH):
            ...
            if cursor.fetchone():
                ...
                cursor.execute("SELECT id, tutorial_complete FROM player_profile WHERE id=1")
    ...
    try:
        while running:
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_ESCAPE:
                        ...
                        print(f"Money: ${getattr(game, 'money', 0)}, Deliveries: {getattr(game, 'successful_deliveries', 0)}")
            ...
            if hasattr(game, 'draw_current_state'):
                ...
                text = font.render("draw_current_state method missing", True, (255, 0, 0))
                screen.blit(text, (20, 20))
