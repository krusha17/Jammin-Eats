...
class Particle:
    ...
    def __init__(self, x, y, color=(255, 255, 255), size=5, velocity=None, decay_rate=0.05, gravity=0.1):
        self.x = x
        self.y = y
        self.color = color
        self.size = size
...
class ParticleSystem:
    ...
    def create_explosion(self, x, y, color=(255, 255, 0), num_particles=20, size=5, decay_rate=0.1):
    ...
    def create_trail(self, x, y, color=(100, 100, 255), num_particles=5, size=3, decay_rate=0.15):
    ...
    def create_sparkle(self, x, y, color=(255, 255, 255), num_particles=10, size=2, decay_rate=0.08):
