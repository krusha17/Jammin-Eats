...
class GameDatabase:
    ...
    def save_player_progress(self, player_id: int, economy_data: Dict, 
                           inventory_data: Dict) -> bool:
        ...
        try:
            ...
            cursor.execute("""
                ...
                WHEN NOT MATCHED THEN
                    ...
                    VALUES (?, ?, ?, ?, ?);
            """, (player_id, economy_data['money'], economy_data['lifetime_earnings'],
                  economy_data['current_map'], economy_data['current_frame'],
                  player_id, economy_data['money'], economy_data['lifetime_earnings'],
                  economy_data['current_map'], economy_data['current_frame']))
    ...
    def log_transaction(self, player_id: int, transaction_type: str, 
                       amount: float, description: str, map_id: int, frame: int):
