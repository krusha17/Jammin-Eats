...
def run_test():
    ...
    try:
        ...
        try:
            with open("C:/Users/jerom/Jammin-Eats/data/jammin.db", "r+"):
    ...
    try:
        ...
        game = Game()
        print(
            f"✓ Game created with state: {type(game.game_state).__name__ if hasattr(game, 'game_state') else None}"
        )
    except Exception as e:
                ...
                if event.type == QUIT:
                    ...
                    if event.key == K_ESCAPE:
                        ...
                        try:
                            ...
                            status = is_tutorial_complete(1)
                            print(
                                f"Tutorial marked complete: {result}, Status: {status}"
                            )
                        ...
                        if hasattr(game, "successful_deliveries"):
                            ...
                            print(
                                f"Deliveries increased to {game.successful_deliveries}"
                            )
